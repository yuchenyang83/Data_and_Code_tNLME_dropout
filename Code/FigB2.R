...
#   Date        :    18.08.2026
#   Purpose     :    produce Figure B.2 for the simulation study by comparing
#                    the MSEs of parameter estimates under the MNAR mechanism
#                    across sample sizes and dropout levels
#
...
#
#   Output data files :  Data_and_Code/Result/FigureB2.pdf
#
#   R Version   :    R-4.6.0
#   Required R packages : ggplot2; ggtext; cowplot; rlang; grid
#
################################################################################
...
pdf(paste0(PATH, "/Result/FigureB2.pdf"), width = 14, height = 10)
multiplot(plotlist = list(mse.sim2), layout = layout)
dev.off()
