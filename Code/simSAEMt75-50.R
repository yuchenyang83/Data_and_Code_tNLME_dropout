...
#                    with nu = 100 and 75% dropout across sample sizes
...
#
#   Output .txt files :  Data_and_Code/Data/simulation/SS-simulation-t75-50/SIM1-SIM5/
#
#   R Version   :    R-4.6.0
...
for (Rep in binrep:Repp) {
  for (ll in seq_along(N)) {
    ...
    if (n == 25) PATH1 <- file.path(PATH, "Data", "simulation", "SS-simulation-t75-50", "SIM1")
    if (n == 50) PATH1 <- file.path(PATH, "Data", "simulation", "SS-simulation-t75-50", "SIM2")
    if (n == 100) PATH1 <- file.path(PATH, "Data", "simulation", "SS-simulation-t75-50", "SIM3")
    if (n == 200) PATH1 <- file.path(PATH, "Data", "simulation", "SS-simulation-t75-50", "SIM4")
    if (n == 400) PATH1 <- file.path(PATH, "Data", "simulation", "SS-simulation-t75-50", "SIM5")
  seednum = Rep + n*1000 + 3e8
  set.seed(seednum)
