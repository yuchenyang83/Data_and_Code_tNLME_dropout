...
#                    additionally fit Scenario (III) models using pooled nls
#                    initial values and the 5000-iteration AR(1) tNLME MNAR model
#                    used for Appendix E
#
#   Input data files  :  Data_and_Code/Data/source/actg398.txt
#
#   Output data files :  Data_and_Code/Data/fit_I_result.RData
#                         Data_and_Code/Data/fit_II_result.RData
#                         Data_and_Code/Data/fit_III_result.RData
#                         Data_and_Code/Data/fit_III_result_nls.RData
#                         Data_and_Code/Data/fit.t.III.ARp.MNAR5000.RData
#
#   R Version   :    R-4.6.0
#
################################################################################
...
cor.type = c("UNC")
set.seed(20260607)
fit.N.I.UNC.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MNAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
#save.image(file.path(SAVE_PATH, "fit.t.I.UNC.MNAR.RData"))

cor.type = c("UNC")
set.seed(20260527)
fit.N.I.UNC.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "I")
#save.image(file.path(SAVE_PATH, "fit.N.I.UNC.MAR.RData"))

set.seed(20260527)
fit.N.I.UNC.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MCAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.UNC.MCAR0527.RData"))

cor.type = c("ARp")
set.seed(20260504)
fit.N.I.ARp.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MNAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.ARp.MNAR.RData"))

cor.type = c("ARp")
set.seed(20260526)
fit.N.I.ARp.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.ARp.MAR.RData"))

cor.type = c("ARp")
set.seed(20260526)
fit.N.I.ARp.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MCAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.ARp.MCAR.RData"))

cor.type = c("CS")
set.seed(20260607)
fit.N.I.CS.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MNAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.CS.MNAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.I.CS.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "I") 
save.image(file.path(SAVE_PATH, "fit.N.I.CS.MAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.I.CS.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MCAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.CS.MCAR.RData"))

cor.type = c("BAND1")
set.seed(20260603)
fit.N.I.BAND1.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.BAND1.MNAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.N.I.BAND1.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.BAND1.MAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.N.I.BAND1.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.I.MCAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.N.I.BAND1.MCAR.RData"))
...
cor.type = c("UNC")
set.seed(20250502)
fit.t.I.UNC.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MNAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
# save.image(file.path(SAVE_PATH, "fit.t.I.UNC.MNAR.RData"))
...
cor.type = c("UNC")
set.seed(20260527)
fit.t.I.UNC.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MCAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
...
cor.type = c("ARp")
set.seed(20250503)
fit.t.I.ARp.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MAR.new, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "I")
# save.image(file.path(SAVE_PATH, "fit.t.I.ARp.MAR.RData"))
 
cor.type = c("ARp")
set.seed(20260605)
fit.t.I.ARp.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MCAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.t.I.ARp.MCAR0527.RData"))

# seed.num = 20260527
cor.type = c("CS")
set.seed(20260527)
fit.t.I.CS.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MNAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
...
cor.type = c("CS")
set.seed(20260527)
fit.t.I.CS.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MCAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.t.I.CS.MCAR.RData"))

# init.t.I.MCAR$nu = 5
cor.type = c("BAND1")
set.seed(20250220)
fit.t.I.BAND1.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.t.I.BAND1.MNAR.RData"))

cor.type = c("BAND1")
set.seed(20260702)
fit.t.I.BAND1.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MAR.new, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.t.I.BAND1.MAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.t.I.BAND1.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.I.MCAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "I")
save.image(file.path(SAVE_PATH, "fit.t.I.BAND1.MCAR.RData"))
...
cor.type = c("UNC")
set.seed(20260526)
fit.N.II.UNC.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.UNC.MAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.N.II.UNC.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MCAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.UNC.MCAR.RData"))

# 
cor.type = c("UNC")
set.seed(20260601)
fit.N.II.UNC.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MNAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.UNC.MNAR.RData"))



cor.type = c("ARp")
set.seed(20260601)
fit.N.II.ARp.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MNAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.ARp.MNAR.RData"))

cor.type = c("ARp")
set.seed(20260526)
fit.N.II.ARp.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MAR, cor.type = c("ARp"), 
                                   M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, 
                                   mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.ARp.MAR.RData"))

cor.type = c("ARp")
set.seed(20260526)
fit.N.II.ARp.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MCAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.ARp.MCAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.II.CS.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MNAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.CS.MNAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.II.CS.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.CS.MAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.II.CS.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MCAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.CS.MCAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.N.II.BAND1.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.BAND1.MNAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.N.II.BAND1.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.BAND1.MAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.N.II.BAND1.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.II.MCAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.N.II.BAND1.MCAR.RData"))
...
cor.type = c("UNC")
set.seed(20260601)
fit.t.II.UNC.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MNAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.UNC.MNAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.t.II.UNC.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.UNC.MAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.t.II.UNC.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MCAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.UNC.MCAR.RData"))

cor.type = c("ARp")
set.seed(20260701)
fit.t.II.ARp.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MNAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.ARp.MNAR.RData"))

cor.type = c("ARp")
set.seed(20260526)
fit.t.II.ARp.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.ARp.MAR.RData"))

cor.type = c("ARp")
set.seed(20260526)
fit.t.II.ARp.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MCAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.ARp.MCAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.t.II.CS.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MNAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.CS.MNAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.t.II.CS.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.CS.MAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.t.II.CS.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MCAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.CS.MCAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.t.II.BAND1.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.BAND1.MNAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.t.II.BAND1.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.BAND1.MAR.RData"))

cor.type = c("BAND1")
set.seed(20260526)
fit.t.II.BAND1.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.II.MCAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "II")
save.image(file.path(SAVE_PATH, "fit.t.II.BAND1.MCAR.RData"))

############################################################
## Structure (III), NLME
############################################################
# init.para = init.t.III.MNAR; cor.type = c("UNC"); M = 10; M.LL = M.LL; P = 1; tol = tol; max.iter = max.iter; per = per; mechanism = "MNAR"; random.structure = "III"
cor.type = c("UNC")
set.seed(20260526)
fit.N.III.UNC.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MNAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.UNC.MNAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.N.III.UNC.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.UNC.MAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.N.III.UNC.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MCAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.UNC.MCAR.RData"))

cor.type = c("ARp")
set.seed(20260528)
fit.N.III.ARp.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MNAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.ARp.MNAR.RData"))

cor.type = c("ARp")
set.seed(20260528)
fit.N.III.ARp.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.ARp.MAR.RData"))

cor.type = c("ARp")
set.seed(20260528)
fit.N.III.ARp.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MCAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.ARp.MCAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.III.CS.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MNAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.CS.MNAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.III.CS.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.CS.MAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.N.III.CS.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MCAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.CS.MCAR.RData"))

cor.type = c("BAND1")
set.seed(20260527)
fit.N.III.BAND1.MNAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.BAND1.MNAR.RData"))

cor.type = c("BAND1")
set.seed(20260527)
fit.N.III.BAND1.MAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.BAND1.MAR.RData"))

cor.type = c("BAND1")
set.seed(20260527)
fit.N.III.BAND1.MCAR <- NLMM.miss.SAEM(Data, g = 1, init.para = init.N.III.MCAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.N.III.BAND1.MCAR.RData"))
...
cor.type = c("UNC")
set.seed(20260526)
fit.t.III.UNC.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MNAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.UNC.MNAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.t.III.UNC.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, 
                                     P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.UNC.MAR.RData"))

cor.type = c("UNC")
set.seed(20260526)
fit.t.III.UNC.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MCAR, cor.type = c("UNC"), M = 10, M.LL = M.LL, 
                                      P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.UNC.MCAR.RData"))
...
cor.type = c("ARp")
set.seed(20250502)
fit.t.III.ARp.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MAR, cor.type = c("ARp"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
...
cor.type = c("CS")
set.seed(20260526)
fit.t.III.CS.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MNAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.CS.MNAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.t.III.CS.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.CS.MAR.RData"))

cor.type = c("CS")
set.seed(20260526)
fit.t.III.CS.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MCAR, cor.type = c("CS"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.CS.MCAR.RData"))

cor.type = c("BAND1")
set.seed(20260527)
fit.t.III.BAND1.MNAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.BAND1.MNAR.RData"))


cor.type = c("BAND1")
set.seed(20260527)
fit.t.III.BAND1.MAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.BAND1.MAR.RData"))

cor.type = c("BAND1")
set.seed(20260527)
fit.t.III.BAND1.MCAR <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MCAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = tol, max.iter = max.iter, per = per, mechanism = "MCAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.BAND1.MCAR.RData"))



cor.type = c("BAND1")
set.seed(20260526)
fit.t.III.BAND1.MNAR.5000 <- tNLMM.miss.SAEM(Data, g = 1, init.para = init.t.III.MNAR, cor.type = c("BAND1"), M = 10, M.LL = M.LL, P = 1, tol = 1e-10, max.iter =5000, per = per, mechanism = "MNAR", random.structure = "III")
save.image(file.path(SAVE_PATH, "fit.t.III.BAND1.MNAR.5000.RData"))
...
############################################################
## Structure (III), NLME: pooled nls initial values
############################################################
...
############################################################
## Structure (III), tNLME: pooled nls initial values
############################################################
