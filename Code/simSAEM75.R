...
#
#   Output .txt files :  Data_and_Code/Data/Simulation/SS-simulationSEM-t75/SIM1/...; 
...
for (Rep in binrep:Repp) {
  for (ll in 1:length(N)) {
    n <- N[ll]
    if (n == 25) PATH1 <- paste0("D:/Data_and_Code", "/Data/Simulation/SS-simulationSEM-t75/SIM1/")
    if (n == 50) PATH1 <- paste0("D:/Data_and_Code", "/Data/Simulation/SS-simulationSEM-t75/SIM2/")
    if (n == 100) PATH1 <- paste0("D:/Data_and_Code", "/Data/Simulation/SS-simulationSEM-t75/SIM3/")
    if (n == 200) PATH1 <- paste0("D:/Data_and_Code", "/Data/Simulation/SS-simulationSEM-t75/SIM4/")
    if (n == 400) PATH1 <- paste0("D:/Data_and_Code", "/Data/Simulation/SS-simulationSEM-t75/SIM5/")
    set.seed(Rep + n*100)
